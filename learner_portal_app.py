...
def init_state():
    ...
    if "materials" not in st.session_state:
        st.session_state.materials = [
            {"title": "Presentation I", "link": "https://github.com/CDAMChukaUniversity/2025-AMMnet_Malaria_Modeling_Workshop/blob/main/Presentation-I.pdf"},
            {"title": "Presentation II", "link": "https://github.com/CDAMChukaUniversity/2025-AMMnet_Malaria_Modeling_Workshop/blob/main/Presentation-II.pdf"},
            {"title": "Presentation III", "link": "https://github.com/CDAMChukaUniversity/2025-AMMnet_Malaria_Modeling_Workshop/blob/main/Presentation-III.pdf"},
        ]
